...
import { genericContractRequestIdentityProvider, genericContractRequestPropertyToken, genericContractRequestRentToOwn } from "./generic";
...
export enum PaymentType { Fixed = 0, Flexible = 1}
...
// getEscrow Balance
export function useGetEscrowBalance(
    propertyId: number,
) { 
...
export function useGetTotalPaidToLandlord(
    propertyId: number,
) { 
    return useContractRead({
        ...genericContractRequestRentToOwn,
...
export function useGetPropertyTokenId(
    propertyId: number,
) { 
    return useContractRead({
        ...genericContractRequestRentToOwn,
...
export function useIsPropertyAvailable(
    propertyId: number,
) { 
    return useContractRead({
        ...genericContractRequestRentToOwn,
...
export function useTotalPaidByTenant(
    propertyId: number,
    tenantAddr: Address
) { 
    return useContractRead({
...
export function useGetTenantEquity(
    propertyId: number,
    tenantAddr: Address
) { 
    return useContractRead({
...
export function useGetPropertyMetadata(
    tokenId: number,
) { 
    return useContractRead({
