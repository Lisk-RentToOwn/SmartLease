      ...
      <main className="min-h-dvh bg-gray-100">
            ...
            <div className="bg-white rounded-lg p-5">
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center space-x-3">
                  <div className="bg-green-500 rounded-full px-3 py-1 text-sm text-white">
                    Occupied
                  </div>
        ...
        <div className="app-container">
          <div className="bg-white p-5 rounded-lg mt-16 mb-16 py-8">
            <p className="text-slate-600 font-semibold text-2xl mb-5">
